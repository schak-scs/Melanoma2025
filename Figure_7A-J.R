...
#save
saveRDS(seurat_object, "Tirosch_seurat_object_celltype.rds")
...
setwd('Melanoma_Tirosch_cell_Annotation_CIBERSORTx')
...
# sig_mat 
mixture_mat <- read.xlsx('CIBERSORTX_input/Merged_Mat.xlsx')
mixture_meta <- read.xlsx('CIBERSORTX_input/sig_mat_meta.xlsx')
...
################################## CIBERSORTx output ##############################################################
data <- read.csv('CIBERSORTx_Job4_Results.csv')
meta <- read.xlsx('CIBERSORTx_output/sig_mat_meta.xlsx')
